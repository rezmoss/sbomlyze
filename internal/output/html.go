...
func GenerateHTML(result analysis.DiffResult, violations []policy.Violation, overview analysis.DiffOverview, findings analysis.KeyFindings) string {
	...
	fmt.Fprintf(&sb, "<p class=\"meta\">Generated by <a href=\"https://github.com/rezmoss/sbomlyze\">sbomlyze</a> · %s</p>\n",
...
func writeHTMLCompliance(sb *strings.Builder, report compliance.Report) {
	...
	fmt.Fprintf(sb, "<p><strong>Overall Score:</strong> %d/100</p>\n", report.Overall)
	...
	for _, fw := range frameworks {
		...
		fmt.Fprintf(sb, "<h3>%s — <span class=\"%s\">%d/100</span> (%d/%d passed)</h3>\n",
